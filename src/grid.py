...
class SudokuGrid:
    ...
    def get_row(self, i):
        ...
        #exemple : ligne 1 = position 0 et les 9 entier qui suivent
        #ligne 2 = position 9 et les 9 entiers qui suivent
        position = (i-1)*9 #avec cette formule on a bien l1 = 0, l2 = 9 etc
